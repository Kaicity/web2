...
<body>
  <form action="" method="get" name="frm1" onsubmit="return validateForm()">
    ...
    <div class="menutren">
      <ul class="menungang">
        ...
        <li class="p2"><a> <img src="../admhtml/images/10_NMT.jpg" style="width: 35px; height: 35px; border-radius: 10px;"></a>
          <div class="option">
  ...
  <div class="carousel">
    <div class="carousel-content">
      <div class="carousel-item"><img src="https://cdn.wccftech.com/wp-content/uploads/2019/12/MSI_5-percent-promo_banner2.gif" alt="Slide 1"></div>
    </div>
  </div>
  <!-- menu3 -->
